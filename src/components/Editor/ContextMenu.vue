...
export default {
    ...
    methods: {
        ...
        cut() {
            this.$store.commit('EditPage/cut')
        },

        copy() {
            this.$store.commit('EditPage/copy')
        },

        paste() {
            this.$store.commit('EditPage/paste', true)
        ...
        upComponent() {
            this.$store.commit('EditPage/upComponent')
            this.$store.commit('EditPage/recordSnapshot')
        },

        downComponent() {
            this.$store.commit('EditPage/downComponent')
            this.$store.commit('EditPage/recordSnapshot')
        },

        topComponent() {
            this.$store.commit('EditPage/topComponent')
            this.$store.commit('EditPage/recordSnapshot')
        },

        bottomComponent() {
            this.$store.commit('EditPage/bottomComponent')
            this.$store.commit('EditPage/recordSnapshot')
        },
    },
}
